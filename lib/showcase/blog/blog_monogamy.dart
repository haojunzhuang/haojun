        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  ...
                  TextSpan(
                    style: bodyHyperlink,
                    text: 'researchers at University of Liverpool ',
                    recognizer: TapGestureRecognizer()
                      ..onTap = () {
                        launch(
            ...
            RichText(
              ...
              TextSpan(
                style: bodyHyperlink,
                text: 'refer to other as “co-wifes”',
                recognizer: TapGestureRecognizer()
                  ..onTap = () {
                    launch('https://blog.siasat.pk/maasai-marriage-story/');
                  },
              ),
              const TextSpan(
                  style: body,
            ...
            RichText(
              ...
              TextSpan(
                style: bodyHyperlink,
                text: '20% to 40% of the divorces are caused by infidelity. ',
                recognizer: TapGestureRecognizer()
                  ..onTap = () {
                    launch(
